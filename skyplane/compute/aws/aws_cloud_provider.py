...
class AWSCloudProvider(CloudProvider):
    ...
    def setup_global(self, iam_name: str = "skyplane_gateway", attach_policy_arn: Optional[str] = None):
        ...
        dynamo_policy = {
            "Version": "2012-10-17",
            "Statement": [{"Sid": "AllowDynamoDBAccessToAllTables", "Effect": "Allow", "Action": "dynamodb:*", "Resource": "*"}],
        }
        iam.put_role_policy(RoleName=iam_name, PolicyName="AllowDynamoDBAccessPolicy", PolicyDocument=json.dumps(dynamo_policy))
